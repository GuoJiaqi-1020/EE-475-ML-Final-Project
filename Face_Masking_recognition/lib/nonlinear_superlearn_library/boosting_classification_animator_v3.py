...
class Visualizer:
    ...
    def animate_trainval_boosting(self,runner,num_frames,**kwargs):        
        ...
        def animate(k):
            ...
            self.plot_train_valid_errors(ax4,k,train_errors,valid_errors,inds)
            return artist,
    ...
    def plot_train_valid_errors(self,ax,k,train_errors,valid_errors,inds):
        ...
        # cleanp panel                
        num_iterations = max(inds)
        minxc = 0.5
        maxxc = num_iterations + 0.5
