...
class Setup:
    ...
    def choose_normalizer(self,name):
        ...
        # set train portion to one by default
    ...
    def fit(self,**kwargs):
        ...
        if optimizer == 'gradient_descent':
            ...
            weight_history = optimizers.gradient_descent(self.cost,self.alpha_choice,self.max_its,self.w_init,self.num_pts,self.batch_size,beta,normalize)
    ...
    def show_histories(self,**kwargs):
        ...
        if 'start' in kwargs:
            start = kwargs['start']
        history_plotters.Setup(self.train_cost_histories,self.train_count_histories,self.valid_cost_histories,self.valid_count_histories,start,**kwargs)
